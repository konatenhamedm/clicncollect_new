...
<div class="relative flex w-full max-w-full sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl flex-col overflow-hidden rounded-lg bg-white shadow-md">
    ...
    <div class="mt-4 px-5 pb-5">
      <a href="#">
        <h5 class="text-xl font-semibold tracking-tight text-slate-900">SOS Livraion</h5>
      </a>
      ...
      <div class="flex items-center justify-between">
        <p>
          ...
          <span class="text-sm text-slate-900 line-througdh">Abobo, Ndotré</span><br>
          <span class="text-md font-bold text-slate-900 line-througdh">Service de livraion</span>
        </p>
